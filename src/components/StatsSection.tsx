...
const stats = [
  ...
  { value: "200+", label: "компаний обучили сотрудников с нами" },
  { value: "100+", label: "авторских программ на основе кейсов Kept" },
  { value: "4.96", label: "средняя оценка практической применимости" },
];
